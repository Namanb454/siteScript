        ...
        <div className='py-24'>
            <div class="flex justify-center items-center w-screen mx-auto h-screen bg-cover py-24">
                <div class="container mx-auto my-4 px-4 lg:px-20">
                    <h1 class="w-fit my-10 font-semibold mx-auto  text-4xl text-[#1C314C] tracking-wider">
                    ...
                    <div class="w-full p-8 my-4 md:px-12 lg:w-9/12 lg:pl-10 lg:pr-40 mr-auto bg-cover rounded-xl shadow-2xl">
                        ...
                        <div class="my-2 w-1/2 lg:w-1/4">
                            <button class="mx-auto inline-flex text-white bg-[#1C314C] border-0 py-2 px-5 focus:outline-none hover:bg-white hover:text-[#1C314C] text-base font-semibold shadow-sm shadow-gray-500">Send Message</button>
                        </div>
                    </div>

                    <div
                        class="w-full lg:-mt-[40%] lg:w-2/6 px-8 py-12 ml-auto bg-cover rounded-2xl"
                        style={{
